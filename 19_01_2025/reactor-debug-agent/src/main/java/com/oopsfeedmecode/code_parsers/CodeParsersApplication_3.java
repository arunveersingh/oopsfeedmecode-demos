...
//@RestController
public class CodeParsersApplication_3 {
    private static final Logger logger = LoggerFactory.getLogger(CodeParsersApplication_3.class);

    public static void main(String[] args) {
        // Enable Reactor Debug Agent for development or testing
        //ReactorDebugAgent.init();
        // Hooks.onOperatorDebug();  // Optional: advanced debug mode
        SpringApplication.run(CodeParsersApplication_3.class, args);
    }
